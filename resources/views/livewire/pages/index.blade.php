    ...
    <section id="featured" class="py-12">
        <div class="container mx-auto px-4">
          ...
          <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <!-- Featured Post 1 -->
            <article class="group overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm transition-all hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
              ...
              <div class="p-6">
                ...
                <p class="mb-4 text-gray-600 dark:text-gray-300">
                  Explore the emerging trends and technologies that will shape the future of web development in the coming years.
                </p>
      ...
      <section class="py-12 bg-gray-50 dark:bg-gray-800/50">
        <div class="container mx-auto px-4">
            ...
            <template x-for="(post, index) in [
              {
                ...
                excerpt: 'An introduction to artificial intelligence and machine learning concepts for beginners.',
                author: 'Alex Johnson',
                date: 'April 20, 2025',
                readTime: '5'
              },
              {
                category: 'Design',
                title: 'Creating Accessible Websites for Everyone',
                excerpt: 'Learn how to make your websites accessible to users with disabilities.',
                author: 'Sarah Miller',
                date: 'April 19, 2025',
                readTime: '7'
              },
              {
                category: 'Business',
                title: 'How to Build a Successful E-commerce Strategy',
                excerpt: 'Essential strategies for building and growing a successful online store.',
                author: 'Michael Chen',
                date: 'April 18, 2025',
                readTime: '8'
              },
              {
                ...
                excerpt: 'Tips for maintaining a healthy relationship with technology in today\'s connected world.',
                author: 'Emily Wilson',
                date: 'April 17, 2025',
                readTime: '4'
              },
              {
                ...
                excerpt: 'Simple mindfulness techniques that busy professionals can incorporate into their daily routines.',
                author: 'David Kim',
                date: 'April 16, 2025',
                readTime: '6'
              },
              {
                ...
                excerpt: 'How to travel responsibly while minimizing your environmental impact.',
                author: 'Jessica Martinez',
                date: 'April 15, 2025',
                readTime: '9'
              }
            ]" :key="index">
              <article class="flex flex-col rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                <div class="mb-2 flex items-center gap-2">
                  <span class="rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-800 dark:text-gray-300" x-text="post.category"></span>
                  <span class="text-xs text-gray-500 dark:text-gray-400" x-text="post.readTime + ' min read'"></span>
                </div>
                <h3 class="mb-2 text-lg font-bold text-gray-900 dark:text-white">
                  <a href="#" class="hover:text-gray-700 dark:hover:text-gray-300" x-text="post.title"></a>
                </h3>
                <p class="mb-4 text-sm text-gray-600 dark:text-gray-300" x-text="post.excerpt"></p>
                <div class="mt-auto flex items-center">
                  ...
                  />
                  <div>
                    <p class="text-xs font-medium text-gray-900 dark:text-white" x-text="post.author"></p>
                    <p class="text-xs text-gray-500 dark:text-gray-400" x-text="post.date"></p>
                  </div>
                </div>
              </article>
            </template>
          ...
          <div class="mt-8 text-center">
            ...
            >
              View All Posts
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right ml-2">
                <path d="M5 12h14"/>
      ...
      <section class="py-12">
        <div class="container mx-auto px-4">
          <h2 class="mb-8 text-2xl font-bold text-gray-900 dark:text-white">Browse by Category</h2>
            ...
            <template x-for="(category, index) in [
              ...
              >
                <div class="mb-3 rounded-full bg-gray-100 p-3 dark:bg-gray-800">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-hash text-gray-700 dark:text-gray-300">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white" x-text="category.name"></h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400" x-text="category.count + ' articles'"></p>
              </a>
            </template>
          </div>
        </div>
          ...
          <div class="mx-auto max-w-2xl text-center">
            ...
            >
              <div class="relative flex-1">
                ...
                />
                <p 
                  class="absolute -bottom-6 left-0 text-xs text-red-400" 
                  x-show="error"
                  x-text="error"
                ></p>
              </div>
              ...
              >
                ...
                <span x-show="submitted">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check inline">
